...
@app.route('/messages/<user_from_id>/<user_to_id>', methods = ['GET']) # returns an array of messages from 'user_from' to 'user_to'
...
def create_message():
    ...
    message = entities.Message( # create a message entity with the data passed in
    ...
    return Response(json.dumps(content, cls=connector.AlchemyEncoder), status=200, mimetype='application/json') # returns the message content
